...
export class DbServiceService {
  ...
  private APIURLFamilia = this.base + '/api/familiasMemorama';
  ...
  public DamePreguntasPuzzle(id): Observable<any> {
    return this.http.get<any[]>('http://localhost:3000/api/Profesores/14/Preguntas/' + id);
